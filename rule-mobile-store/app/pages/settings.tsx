...
const Settings = () => {
  ...
  const textSm = 'text-sm sm:text-base font-semibold text-gray-800';
      ...
      <IonPage id='main-content'>
        <IonHeader>
            <IonToolbar>
              ...
              <IonTitle className='text-center font-semibold mr-12 text-gray-800'>設定</IonTitle> {/* Default title */}
            </IonToolbar>
          </IonHeader>
