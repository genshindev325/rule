      ...
      <IonPage id='main-content'>
        <IonHeader>
          <IonToolbar>
            ...
            <IonTitle className='text-center font-semibold mr-12 text-gray-800'>店舗プロフィール設定</IonTitle> {/* Default title */}
          </IonToolbar>
        </IonHeader>
          ...
          <div className='bg-white w-full ion-padding text-gray-800'>
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-2">
                ...
                <textarea
                  name='description'
                  className={`text-xs sm:text-sm w-full p-2 mt-3 bg-gray-100 rounded-md focus:outline-none focus:border-blue-100`}
                  placeholder="説明文"
                  rows={3}
                />
              </div>
