...
const EventPayment: React.FC = () => {
  ...
  return (
    <div className="flex items-start justify-center min-h-screen w-screen bg-white">
      ...
      <div className="py-6 md:py-12 px-12 flex flex-row text-xl text-white md:text-3xl font-bold text-center">
        <button type='button' className='flex bg-transparent border-none w-12 text-white text-left items-center justify-center font-bold'>K</button>
        <h2 className='grow'>イベントに参加</h2>
      </div>
      {/* event attend to participate */}
      <div className="flex flex-row space-x-2 bg-white rounded-xl shadow-xl px-4 md:px-8 py-6 md:py-12 mx-8 md:mx-20 md:mt-6 mb-12 md:mb-20">
        ...
        <div className='flex flex-col space-y-1'>
          ...
          <div className='flex flex-row space-x-1'>
            <div className={`${maleGradient} px-1 rounded-full w-10 text-center text-xs text-white`}>男性</div>
          ...
          <div className='flex flex-row space-x-1'>
            <div className={`${femaleGradient} px-1 rounded-full w-10 text-center text-xs text-white`}>女性</div>
      ...
      <div className='flex flex-col justify-center'>
        ...
        <form onSubmit={handleSubmit} className='mt-8 md:mt-16 bg-white'>
          <div className='px-4 md:px-8 bg-gray-100 pb-8'>
            ...
            <div className="mt-4 bg-white rounded-md">
              ...
              <div className="flex justify-around">
                ...
                <img src="/mastercard.png" alt="MasterCard" className="h-12" />
                <img src="/jcb.png" alt="JCB" className="h-12" />
                <img src="/amex.png" alt="American Express" className="h-12" />
              </div>
            </div>
            <div className="mt-4">
          ...
          <h2 className='text-md text-center pt-6'>##############################</h2>
          ...
          <div className="mt-6 justify-center flex">
            <button className={`w-64 ${maleGradient} text-white py-2 rounded-full hover:bg-purple-600`}>決済する</button>
          </div>
          <div className="mt-4 pb-12 md:pb-20 flex justify-center">
            <button className="w-64 bg-gray-500 text-white py-2 rounded-full bg-gray-300 hover:bg-gray-400">キャンセル</button>
          </div>
          {/*  */}
        </form>
      </div>
