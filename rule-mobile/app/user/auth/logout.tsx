            ...
            <div className="bg-white rounded-2xl shadow-xl px-4 sm:px-6 md:px-8 mx-5 sm:mx-6 md:mx-8 mt-20 sm:mt-24 md:mt-28">
              ...
              <div className='flex flex-row space-x-4 pb-10'>
                <button
                  ...
                  className="w-full text-sm sm: text-base py-2 px-4 bg-red-400 text-white rounded-md hover:bg-red-500 focus:outline-none duration-500"
                >
                  ログアウト
                </button>
                <button
                  ...
                  className="w-full text-sm sm: text-base py-2 px-4 bg-gray-400 text-white rounded-md hover:bg-gray-500 focus:outline-none duration-500"
                >
                  キャンセル
                </button>
              </div>
