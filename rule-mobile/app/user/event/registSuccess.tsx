      ...
      <IonContent>
        <AuthWrapper allowedRoles={['user']}>
          <div className={`flex flex-col items-center min-h-screen w-screen ${maleGradient} px-4`}>
            ...
            {/* content */}
            <div className='rounded-lg bg-white p-4 px-2 md:px-4 mb-4 flex flex-col items-center space-y-1'>
              ...
              <img src={selectedEvent.coverImage} alt={`event-profile`} width={350} height={70} className="py-2" />
              ...
              <h2 className='py-1 text-xs'>{selectedEvent.description}</h2>
            </div>
            {/* button */}
